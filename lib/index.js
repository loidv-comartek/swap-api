...
class LiquidityAPI {
    ...
    getPairByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const reserve0 = this.toTokenNumber(reserves._reserve0, token0Info.decimals);
            const reserve1 = this.toTokenNumber(reserves._reserve1, token1Info.decimals);
            ...
            const price = this.getPrice(this.toDecimal(reserves._reserve0), this.toDecimal(reserves._reserve1), token0Info.decimals, token1Info.decimals);
    ...
    toTokenNumber(value, decimals) {
        const total = new bignumber_js_1.default(value._hex || value).dividedBy(Number(`10e${decimals - 1}`));
    ...
    getPrice(r0, r1, d0, d1) {
        ...
        const price0 = new bignumber_js_1.default(Number(`10e${d1 - 1}`))
            .dividedBy(value)
            .toString(10);
        return {
            price0,
